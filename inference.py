...
def get_dataset(args, model_args, filtering=False):
    if args.dataset == 'pdbbind':
        dataset = PDBBind(transform=None, root=args.data_dir, limit_complexes=args.limit_complexes,
                        chain_cutoff=args.chain_cutoff if args.use_full_size_protein_file else model_args.chain_cutoff,
                        use_original_protein_file=args.use_original_protein_file,
