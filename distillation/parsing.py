...
def parse_distillation_args():
    ...
    parser.add_argument('--use_old_wrong_embedding_order', action='store_true', default=False, help='')
    ...
    parser.add_argument('--tor_sigma_min', type=float, default=0.06, help='Minimum sigma for torsional component')
    parser.add_argument('--tor_sigma_max', type=float, default=3.1, help='Maximum sigma for torsional component')
    ...
    parser.add_argument('--distillation_complexes_dir', type=str, default=None, help='Path to directory with generated complexes from inference')
    parser.add_argument('--inference_out_dir', type=str, default=None, help='Path to output directory of inference')
    parser.add_argument('--distillation_train_cluster', type=str, default=None, help='Name of cluster for fine-tuning')
