...
class MOAD(Dataset):
    ...
    def get_receptor(self, par):
        ...
        rec_path = os.path.join(self.moad_dir, 'dockgen_protein', name + '_protein_chain_removed.pdb')
    ...
    def get_ligand(self, name):
        if self.split == 'train':
            ...
            lig_path = os.path.join(self.moad_dir, 'dockgen_ligand', name + '.pdb')
        ...
        if self.split != 'train':
            ...
            nsplit = name.split('_')
            for i in range(100):
                new_file = os.path.join(self.moad_dir, 'dockgen_ligand', f'{nsplit[0]}_{nsplit[1]}_{nsplit[2]}_{i}.pdb')
